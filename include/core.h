...
#ifndef C_CODINGBAT_INCLUDE_CORE_H
#define C_CODINGBAT_INCLUDE_CORE_H
#define MAX_BITS 64
#define AND &&
#define OR ||
...
BOOL in_order(const int a, const int b, const int c, BOOL bOk);
BOOL in_order_equal(const int a, const int b, const int c, BOOL equal_ok);
